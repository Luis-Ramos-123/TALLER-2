...
map.getView().fit([-9142110.475233, -690999.775858, -8779582.686370, -409474.925217], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Unidades Geologicas de PIURA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (19 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Luis Ramos Sangay ';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_geologiapiura_practi_1,
    colName: 'SIMBOLO_',
    zoom: 10,
    collapsed: true,
    map: map
